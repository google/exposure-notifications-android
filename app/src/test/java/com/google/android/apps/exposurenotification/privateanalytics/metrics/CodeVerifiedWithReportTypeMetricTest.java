...
import static com.google.android.apps.exposurenotification.privateanalytics.metrics.CodeVerifiedWithReportTypeMetric.BIN_LENGTH;
...
/**
 * Tests of {@link CodeVerifiedWithReportTypeMetric}.
 */
@HiltAndroidTest
@RunWith(RobolectricTestRunner.class)
@Config(application = HiltTestApplication.class)
@UninstallModules({RealTimeModule.class})
public class CodeVerifiedWithReportTypeMetricTest {
  ...
  @Test
  public void testCodeVerifiedNoReportSinceLastWorkerRun() throws Exception {
    // GIVEN
    ...
    // WHEN
    List<Integer> vector = codeVerifiedWithReportTypeMetric.getDataVector().get();
  ...
  @Test
  public void testCodeVerifiedReportInTimePeriodSinceLastWorkerRun() throws Exception {
    // GIVEN
  ...
  @Test
  public void testCodeVerifiedNoReportInTimePeriodSinceLastWorkerRun() throws Exception {
    // GIVEN
  ...
  public void testHammingWeight() {
    assertThat(codeVerifiedWithReportTypeMetric.getMetricHammingWeight()).isEqualTo(0);
  }
