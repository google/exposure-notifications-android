...
/**
 * Tests of {@link KeysUploadedVaccineStatusBiweeklyMetric}.
 */
@HiltAndroidTest
@RunWith(RobolectricTestRunner.class)
@Config(application = HiltTestApplication.class)
@UninstallModules({RealTimeModule.class})
public class KeysUploadedVaccineStatusBiweeklyMetricTest {

  @Rule
  public ExposureNotificationRules rules = ExposureNotificationRules.forTest(this).build();

  @Inject
  KeysUploadedVaccineStatusBiweeklyMetric keysUploadedVaccineStatusBiweeklyMetricMetric;
  ...
  public void testGetDataVector_keyUploadBeforeWorkerLastRun_noKeyUpload() throws Exception {
    ...
    // WHEN
    List<Integer> vector = keysUploadedVaccineStatusBiweeklyMetricMetric.getDataVector().get();
  ...
  public void testHammingWeight() {
    assertThat(keysUploadedVaccineStatusBiweeklyMetricMetric.getMetricHammingWeight()).isEqualTo(0);
  }
