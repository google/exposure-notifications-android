...
/**
 * Result page for exposure shared confirmation flows
 *
 * <p><ul>
 ...
 * </ul><p>
 */
public class ShareExposureSharedFragment extends Fragment {

  private static final String TAG = "ShareExposureSharedFrag";

  @Override
  public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
    return inflater.inflate(R.layout.fragment_share_exposure_shared, parent, false);
  }
