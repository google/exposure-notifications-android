...
import static com.google.android.apps.exposurenotification.privateanalytics.PrivateAnalyticsFirestoreRepository.SCHEMA_VERSION_KEY;
import static com.google.android.apps.exposurenotification.privateanalytics.PrivateAnalyticsFirestoreRepository.UUID;
...
import com.google.android.apps.exposurenotification.proto.Payload;
 ...
 */
public class PrivateAnalyticsDeviceAttestation {

  private static final String TAG = "PrioDeviceAttestation"; // Logging TAG
  ...
  @Inject
  PrivateAnalyticsDeviceAttestation(@ApplicationContext Context context, Clock clock) {
