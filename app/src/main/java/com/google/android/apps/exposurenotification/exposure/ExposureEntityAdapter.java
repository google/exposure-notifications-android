...
public class ExposureEntityAdapter
    extends ListAdapter<ExposureEntity, ExposureEntityAdapter.ViewHolder> {
  ...
  public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    View view = inflater.inflate(R.layout.item_exposure_entity, viewGroup, false);
  ...
  static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    void bind(ExposureEntity item) {
      ...
      String formatted =
          StringUtils.epochTimestampToMediumUTCDateString(item.getDateMillisSinceEpoch(), locale);
  ...
  private static class ExposureItemCallback extends DiffUtil.ItemCallback<ExposureEntity> {
    ...
    @Override
    public boolean areItemsTheSame(@NonNull ExposureEntity left, @NonNull ExposureEntity right) {
      return left.getId() == right.getId();
    }

    @Override
    public boolean areContentsTheSame(@NonNull ExposureEntity left, @NonNull ExposureEntity right) {
